...
const MostrarSolicitudAdministrador = ({ id, onClose }) => {
  ...
  useEffect(() => {
    console.log("ID de solicitud recibido:", id);
    const fetchSolicitud = async () => {
      try {
        ...
        const response = await fetch(
          `${API_URL}/Informes/listar-solicitud-empleado/${id}/`,
          {
            headers: {
    ...
    <div className="p-4">
      <div className="mb-6 border-2 border-gray-600 rounded-lg p-4">
        <h2 className="mb-6 border-2 border-gray-600 rounded-lg p-4 text-center font-bold">
          SOLICITUD DE AUTORIZACIÓN PARA CUMPLIMIENTO DE SERVICIOS
          INSTITUCIONALES
        </h2>
...
export default MostrarSolicitudAdministrador;
