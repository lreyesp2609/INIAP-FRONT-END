  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="mb-6 border-2 border-gray-600 rounded-lg p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold">Ordenes de Movilizacion</h2>
        </div>
        ...
        <button
          ...
          className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mt-6"
        >
          Generar Reporte
        </button>
      </div>
