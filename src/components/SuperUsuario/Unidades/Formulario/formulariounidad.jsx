  ...
  return (
    ...
    <div>
      ...
      <select
        ...
        className="w-full bg-blue-100 text-black border border-blue-100 rounded-md py-2 px-4 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
      >
